  ...
  return (
    <section className="bg-[#e5ecfb] lg:min-h-screen" id="about">
      ...
      <div className="flex flex-row gap-[2rem] flex-wrap p-[0.5rem] md:p-[2.5rem] mb-[7rem] md:mb-0">
        <div className="text-left flex-[1_1_35rem] mt-[2rem] md:mt-0">
          <img ref={tiltRef} draggable="false" className="tilt ml-0 mr-auto w-[70%] min-[400px]:w-[22rem] md:mt-[2rem] md:w-[30rem] h-auto rounded-[5%] shadow-[0_5px_10px_rgba(0,0,0,0.6)] transition-all duration-300 cursor-pointer hover:mix-blend-normal" src="/assets/images/aniket.jpg" alt="" />
        </div>
